...
//        let URL_EXAMPLE = "https://api.soleo.com/businesses/?APIKey=YOURAPIKEY&ANI=5856414300&ReferenceID=T7360&Keyword=food&Latitude=43.038304720296516&Longitude=-77.4576846095582&Sort=value_distance"
    ...
    var toSearch_keyword : String
    var toSearch_Name : String
    var toSearch_Category : String
    
    // If Location is provded, City,Sate,PostalCode is not requiered.
    var location : CLLocation
    var toSearch_City : String
    var toSearch_State : String
    var toSearch_PostalCode : Int
    
    var toSearch_radious : String
    
    //Extras
    
    var OpenOnly : Bool = false
    var sortType : Business_Sort_Type = Business_Sort_Type.both
    var requestType : Business_Request_Type = Business_Request_Type.ALL

    
    //Return Values
    var businessList = [Business]()
    var foundOrganics : Int = 0
    var foundSponsors : Int = 0
    var totalFound : Int = 0
    var resultsValidUntil : NSDate = NSDate()
    
    var dataError : NSError?
    var SearchRequest : Search_type?
