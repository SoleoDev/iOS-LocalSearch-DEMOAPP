...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func buildNavDrawer()
    {
        ...
        //Main Page
        let mainPage = mainStoryBoard.instantiateViewControllerWithIdentifier("TabBarViewController") as! TabBarViewController

        //LeftSideMenu
        let leftMenu = mainStoryBoard.instantiateViewControllerWithIdentifier("LeftViewController") as! LeftViewController
        //RightSideMenu
