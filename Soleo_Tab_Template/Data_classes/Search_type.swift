...
public struct PropertiesKey{
    ...
    static let search_queryKey = "query"
    
    static let timeKey = "time"
    
    static let location = "location"
    
    static let favorityKey = "fav"
...
public class Search_type : NSObject, NSCoding {
    ...
    var search_time : NSDate
    var search_location : CLLocation
    var favority: Bool
    
    //MARK: Data Path
    static let DocumentsDictonary = NSFileManager().URLsForDirectory(.DocumentDirectory, inDomains: .UserDomainMask).first!
    
    static let ArchiveURL = DocumentsDictonary.URLByAppendingPathComponent("search_type")
     ...
     */
    init?(name: String,query: String, timeS: NSDate, location: CLLocation, fav: Bool){
